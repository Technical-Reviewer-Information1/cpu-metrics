...
『大学入学共通テスト「情報Ⅰ」対策問題集』（技術評論社, ISBN 978-4-297-15084-6）pp.181 連動Webアプリ。

**公開URL**: https://technical-reviewer-information1.github.io/cpu-metrics/

クロック信号の波形を見ながら、1秒間に何命令実行できるかを計算します。ビット数と扱えるメモリ空間の関係も確かめられます。
